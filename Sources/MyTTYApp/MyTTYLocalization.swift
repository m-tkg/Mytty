...
enum MyTTYText: String {
    ...
    case addBookmark = "Bookmark This Line"
    case bookmarks = "Bookmarks"
    case emptyLineBookmark = "(empty line)"
    case delete = "Delete"
    case moveToTab = "Move to Tab"
    ...
    case showPaneStatusBar = "Show a status bar in each pane"
    case showPaneStatusBarNote =
    ...
    case agentContextWarning = "Warn on low context"
    ...
    case teachPaneTeamPointersDescription = "For Claude Code and Codex, add a short reference to the bundled usage guide (mytty-ctl.md) that agents consult whenever a request mentions Mytty at all, not only when asked to run sub-agents across panes."
    case orchestration = "Orchestration"
    case orchestrationOverviewDescription = "Any agent running in a Mytty pane can drive mytty-ctl to open another pane, launch a second agent in it, and work with it as a team. No background process is required. This section gathers the pieces that setup needs: the note that teaches an agent to find it, and how to actually ask for it."
    ...
    case orchestrationExampleGuidanceOnLabel = "Guidance on"
    ...
    case viewReleaseNotes = "View the release notes on GitHub"
    ...
    case autoNameAgentTabs = "Auto-Name Tabs From Agent Conversations"
    ...
    case forceASCIIInputOnFocus
        = "Switch to ASCII input when focus returns"
    case forceASCIIInputScopeShellIdleOnly = "Only while the shell is idle"
    case forceASCIIInputScopeAlways = "Always, in any pane"
    ...
    case remotePaneBadge = "Remote"
    case remotePane = "Remote Pane"
    case closeRemotePane = "Close Remote Pane"
    case remoteNeedsAttention = "Needs attention on the host"
    case remoteConnecting = "Connecting…"
    case remoteDisconnected = "Disconnected"
    case remoteReconnect = "Reconnect"
    case remoteInputDisabled = "Input is disabled until reconnected."
    case remotePaneClosedOnHost = "This pane is no longer open on the host."
    case remoteMacs = "Remote Macs"
    case remoteMacsDescription = "Open panes onto terminals running on another Mac."
    case remoteMacsOpenHint = "Open panes on these Macs from Pane › Open Remote Pane… in the menu bar, or with the button on each row."
    case addRemoteMac = "Add Mac…"
    case noRemoteMacs = "No Macs paired yet."
    case pairingLink = "Pairing link"
    case pairingLinkInstructions = "On the other Mac, open Settings › Remote Access, generate a pairing code and copy its link."
    case copyPairingLink = "Copy Pairing Link"
    case pairingLinkCopied = "Copied"
    case remoteMacName = "Name"
    case remoteMacAddress = "Address"
    case pairWithMac = "Pair"
    case pairingFailed = "Pairing failed"
    case openRemotePane = "Open Remote Pane…"
    case chooseRemotePane = "Choose a pane to mirror"
    case remotePaneOpenDestination = "Open in"
    case noRemotePanesAvailable = "No panes are open on this Mac."
    case removeRemoteMac = "Remove Mac"
    case removeRemoteMacQuestion = "Remove this Mac?"
    case removeRemoteMacWarning = "Open panes mirroring it stop updating, and pairing has to be done again."
    ...
    case workCompleted = "Task completed"
    ...
    case completionFallback = "Long-running task completed successfully."
    ...
    case enableRemoteAccess = "Enable Remote Access"
    case remoteAccessDescription = "Let the Mytty iOS app or another Mac view and type into panes over your local network."
    case generatePairingCode = "Generate Pairing QR Code"
    case pairingCode = "Pair a Device"
    case cancelPairing = "Cancel Pairing"
    case pairingCodeInstructions = "Scan this QR code with the Mytty iOS app within 2 minutes."
    case pairingCodeExpired = "This QR code has expired. Generate a new one."
...
struct MyTTYLocalizer: Equatable {
    ...
    private func japanese(_ key: MyTTYText) -> String {
        ...
        case .addBookmark: "この行をブックマーク"
        case .bookmarks: "ブックマーク"
        case .emptyLineBookmark: "(空行)"
        case .delete: "削除"
        case .moveToTab: "別のタブへ移動"
        ...
        case .showPaneStatusBar: "各ペインにステータスバーを表示"
        case .showPaneStatusBarNote: "タブが 2 ペイン以上に分割されているときだけ表示します。"
        case .branch: "ブランチ"
        case .cursor: "カーソル"
        case .shape: "形状"
        case .block: "ブロック"
        ...
        case .agentContextWarning: "コンテキスト残量が少ないときに警告"
        ...
        case .teachPaneTeamPointersDescription: "Claude Code と Codex に、同梱の使い方ガイド (mytty-ctl.md) への短い参照を追加します。複数ペインでサブエージェントを動かす依頼に限らず、依頼に Mytty が出てきた時点で agent が参照します。"
        case .orchestration: "オーケストレーション"
        case .orchestrationOverviewDescription: "ペインで動いている Agent は mytty-ctl を使って別のペインを開き、そこに別の Agent を起動してチームとして動かせます。常駐プロセスは不要です。このセクションには、そのために必要なもの(それを見つけさせる案内、実際の呼び出し方)をまとめています。"
        ...
        case .orchestrationExampleGuidanceOnLabel: "案内あり"
        ...
        case .releaseNotes: "リリースノート"
        case .viewReleaseNotes: "GitHub でリリースノートを開く"
        ...
        case .autoNameAgentTabs: "エージェントの会話からタブを自動命名"
        case .tabUptime: "経過時間"
        ...
        case .forceASCIIInputOnFocus: "フォーカス復帰時、英数入力に切り替える"
        case .forceASCIIInputScopeShellIdleOnly: "シェル待機中のみ"
        case .forceASCIIInputScopeAlways: "常に"
        ...
        case .browser: "ブラウザ"
        case .remotePaneBadge: "リモート"
        case .remotePane: "リモートペイン"
        case .closeRemotePane: "リモートペインを閉じる"
        case .remoteNeedsAttention: "接続先の Mac で確認待ち"
        case .remoteConnecting: "接続中…"
        case .remoteDisconnected: "切断されました"
        case .remoteReconnect: "再接続"
        case .remoteInputDisabled: "再接続するまで入力できません。"
        case .remotePaneClosedOnHost: "このペインは接続先の Mac で閉じられました。"
        case .remoteMacs: "リモートの Mac"
        case .remoteMacsDescription: "別の Mac で動いているターミナルをペインとして開きます。"
        case .remoteMacsOpenHint: "これらの Mac のペインは、メニューバーの ペイン › リモートペインを開く… か、各行のボタンから開けます。"
        case .addRemoteMac: "Mac を追加…"
        case .noRemoteMacs: "ペアリング済みの Mac はありません。"
        case .pairingLink: "ペアリングリンク"
        case .pairingLinkInstructions:
            "接続先の Mac で設定 › リモートアクセスを開き、ペアリングコードを生成してリンクをコピーしてください。"
        case .copyPairingLink: "ペアリングリンクをコピー"
        case .pairingLinkCopied: "コピーしました"
        case .remoteMacName: "名前"
        case .remoteMacAddress: "アドレス"
        case .pairWithMac: "ペアリング"
        case .pairingFailed: "ペアリングに失敗しました"
        case .openRemotePane: "リモートペインを開く…"
        case .chooseRemotePane: "表示するペインを選択"
        case .remotePaneOpenDestination: "開き先"
        case .noRemotePanesAvailable: "この Mac で開いているペインはありません。"
        case .removeRemoteMac: "Mac を削除"
        case .removeRemoteMacQuestion: "この Mac を削除しますか？"
        case .removeRemoteMacWarning:
            "表示中のリモートペインは更新されなくなり、ペアリングをやり直す必要があります。"
        ...
        case .remote: "リモートアクセス"
        case .enableRemoteAccess: "リモートアクセスを有効にする"
        case .remoteAccessDescription: "同一ネットワーク上の Mytty iOS アプリや他の Mac からペインの内容を表示し、入力できるようにします。"
        case .generatePairingCode: "ペアリング用 QR コードを生成"
        case .pairingCode: "デバイスをペアリング"
        case .cancelPairing: "ペアリングをキャンセル"
        case .pairingCodeInstructions: "この QR コードを2分以内に Mytty iOS アプリでスキャンしてください。"
        case .pairingCodeExpired: "この QR コードは失効しました。新しいものを生成してください。"
...
private extension MyTTYCommand {
    ...
    var textKey: MyTTYText? {
        ...
        case .openRemotePane: .openRemotePane
