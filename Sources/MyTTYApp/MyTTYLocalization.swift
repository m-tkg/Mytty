...
enum MyTTYText: String {
    ...
    case showCommandResultBadge = "Show exit code and elapsed time when a command finishes"
...
struct MyTTYLocalizer: Equatable {
    ...
    private func japanese(_ key: MyTTYText) -> String {
        ...
        case .commandResult: "コマンド結果"
        case .showCommandResultBadge: "コマンド終了時に終了コードと実行時間を表示"
