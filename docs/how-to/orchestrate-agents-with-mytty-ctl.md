...
Turning on "Teach agents about Mytty orchestration" writes `mytty-ctl`
usage into `~/.claude/skills/mytty-panes/SKILL.md` and
`~/.codex/AGENTS.md`.

"Show what will be written" reveals the exact text before anything is
saved; opening it alone doesn't write anything.
