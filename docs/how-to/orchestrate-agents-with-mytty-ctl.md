...
This only needs the CLI installed -- no changes to the CLAUDE.md or AGENTS.md currently in use.

### Write the usage into CLAUDE.md or AGENTS.md ahead of time

Writing the usage into CLAUDE.md or AGENTS.md means you don't have to spell out "first run `mytty-ctl guide`" every time -- a prompt like this is enough:
