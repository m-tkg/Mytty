...
このドキュメントは [Diataxis](https://diataxis.fr) の構成に従っている。4
つの区分はそれぞれ違う種類の疑問に答えるので、今知りたいことに合う区分
から読むとよい。

## チュートリアル

手を動かしながら覚える。Mytty が初めてならここから。
...
- [pane への入力を日時指定で送る](how-to/schedule-input_ja.md)

## リファレンス

事実そのもの。設定項目、コマンド、ワイヤーフォーマットを網羅する。

- [設定リファレンス](reference/settings_ja.md)
- [キーボードショートカット リファレンス](reference/keyboard-shortcuts_ja.md)
...
- [`.claude/skills/mytty-panes/SKILL.md`](../.claude/skills/mytty-panes/SKILL.md) には `mytty-ctl` を使ったタスクレシピがある。
